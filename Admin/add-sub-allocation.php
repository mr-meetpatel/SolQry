...
session_start();
$faculty= mysqli_query($con, "select * from faculty_master where b_id='{$_SESSION['b_id']}'");
if(isset($_POST['btn']))
{
    $name= strtoupper(mysqli_real_escape_string($con,$_POST['faculty']));
    ...
    $sem= mysqli_real_escape_string($con,$_POST['sem']);
        ...
        $q= mysqli_query($con,"INSERT INTO `sub_allocation_master` ( `u_id`, `id`, `sub_id`, `b_id`) VALUES ( '2', '{$name}', '{$sub}', '{$_SESSION['b_id']}');") or die(mysqli_error($con));
        
        
        
        if($q)
        {
            echo "<script>alert('Subject Allocated  successfully');window.location='add-sub-allocation.php';</script>";
        }
          ...
          <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <select class="form-control" id="input-6" name="sem" onchange="myfuc(this.value)" required>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="sub-data" name="sub" required>
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="sub-data" name="faculty" required>
                        <?php
...
//});
    ...
    $.ajax({
        ...
        url: "display-subject1-data.php",
        type: 'POST',
        data:{ datapost:data },
        success: function (result) {
                $("#sub-data").html(result);        
                    }
