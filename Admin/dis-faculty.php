  ...
  swal({
                  ...
                  .then((willDelete) => {
                   ...
                   success:function(data)
                   {
                    ...
                    if(data=="Faculty Data Deleted Successfully!"){
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Faculties List <button class="btn btn-light pull-right" onclick="display()">Refresh</button></div>
            <div class="card-body">
