	...
	swal({
                  ...
                  .then((willDelete) => {
                    if (willDelete) {
                      ...
                      $.ajax({
                   url:"display-deleted-faculty-data.php",
                   type:"POST",
                   data:{
                     fid:fid,
                   },
                   success:function(data)
                   {
                    ...
                    if(data=="Faculty Data Has Restore!"){
                  ...
                  display();
                        ...
                        swal("Faculty Data is not Restored!");
                    }
                  });
}
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Old Faculties List <button class="btn btn-light pull-right" onclick="display()">Refresh</button></div>
            <div class="card-body">
