...
<div class="clearfix"></div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-header"><i class="fa fa-table"></i> Subject Allocation List</div>
            <div class="card-body">
                <form>
                  <div class="form-group row">
                  
                  <div class="col-sm-3">
                    <select class="form-control" id="input-6" name="sem" onchange="myfuc(this.value)">
  ...
  <script src="../assets/plugins/alerts-boxes/js/sweet-alert-script.js"></script>
    ...
    $.ajax({
        ...
        url: "display-allocation-data.php",
        type: 'POST',
        data:{ datapost:data },
