...
if(isset($_POST['btn']))
{
    ...
    if($new==$cnew)
    {
        $u=mysqli_query($con,"update admin_master set admin_pass='{$new}' where admin_id='{$_SESSION['faid']}'");
        if($u)
        {
		  ...
		  <div class="card-title text-uppercase text-center py-3">Forget Password</div>
			  ...
			  <label for="exampleInputUsername" class="sr-only" >Enter New Password</label>
			   <div class="position-relative has-icon-right">
                               <input type="text" id="exampleInputUsername" class="form-control input-shadow" placeholder="Enter Email" name="new1">
			  ...
			  <label for="exampleInputUsername" class="sr-only" >Confirm Password</label>
			   <div class="position-relative has-icon-right">
                               <input type="text" id="exampleInputUsername" class="form-control input-shadow" placeholder="Enter Email" name="new2">
				  <div class="form-control-position">
					  <i class="icon-user"></i>
				  </div>
			   </div>
