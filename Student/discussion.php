...
$diss=mysqli_query($con,"select * from discussion_forum_master where diss_id='{$_GET['disid']}'");
$dissdata=mysqli_fetch_array($diss);
$fname=mysqli_query($con,"select f_name from faculty_master where f_id='{$dissdata['f_id']}'");
$fnamedata=mysqli_fetch_array($fname);


if(isset($_POST['send'])){
    $msg=mysqli_real_escape_string($con,$_POST['txt']);
    $msg=mysqli_query($con,"INSERT INTO `discussion_master`(`diss_id`,`stu_id`, `dis_msg`) VALUES ('{$_GET['disid']}','{$_SESSION['sid']}','{$msg}')") or die(mysqli_error($con));
    ...
    <div class="container-fluid">
      ...
      <div class="row">
	   <div class="col-12 col-lg-12">
	    <div class="card">
			<div class="card-body">
				<div class="card-title"><i><?php echo $dissdata['diss_title'];?></i>
				  
				</div>
				<h6>By <?php echo $fnamedata['f_name'];?></h6>
  ...
  <script>
     $(document).ready(function() {
      ...
      setInterval(function(){
        ...
        {
            $.ajax({
               url: "display-stu-discussion-data.php",
               type:"POST",
