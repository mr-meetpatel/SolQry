...
session_start();
 ...
 $admin= mysqli_query($con, "select * from admin_master where b_id='{$_SESSION['sbid']}'");
...
if(isset($_POST['btn']))
{
    ...
    $stuid= $_SESSION['sid'];
     ...
     $q= mysqli_query($con, "INSERT INTO `appointment_master` ( `stu_id`, `u_id`,`b_id`,`f_id`, `appiontment_details`) VALUES ( '{$stuid}','1','{$_SESSION['sbid']}','{$row['admin_id']}','{$app}');");
    $notifications= mysqli_query($con, "INSERT INTO `notification_master` ( `n_from`, `n_to`,`b_id`,`id`,`notification`, `status`) VALUES ( '3', 'Admin','{$_SESSION['sbid']}','{$row['admin_id']}','New Appointment Added', '1');");
     if($q)
     {
          ...
          <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <label for="input-6" class="col-sm-2 col-form-label"><?php
                   
                    echo $row['admin_name']."[HOD]";
                    ?></label>
