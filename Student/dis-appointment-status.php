...
$updatenotification=mysqli_query($con,"update notification_master set status=0 where n_to='Student' and b_id='{$_SESSION['sbid']}' and id='{$_SESSION['sid']}' and notification='Appointment Accepted '");
        ?>
<script>
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Appointments List</div>
            <div class="card-body">
    ...
    <script>
     $(document).ready(function() {
      ...
      setInterval(function(){
        ...
        {
            $.ajax({
               url: "display-appointment-status-data.php",
               type:"POST",
