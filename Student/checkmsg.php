...
$res="";
$res1="";
$sql=mysqli_query($con,"select * from query_master where   msg_from='{$_POST['stu']}'  and msg_to='{$_POST['faculty']}' or msg_from='{$_POST['faculty']}'  and msg_to='{$_POST['stu']}'");
...
if(mysqli_num_rows($sql)>0)
{
    while($row=mysqli_fetch_array($sql))
    {
     ...
     $res=$res."<div class='container '>";    
     $res=$res."<p><b>Faculty</b>: $row[query]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>";//<a href='chat.php?id=$row[q_id]' class='left'>Delete</a>
