...
{
    $new=sha1($_POST['new1']);
    $cnew=sha1($_POST['new2']);
    if($new==$cnew)
    {
        $u=mysqli_query($con,"update student_master set stu_pass='{$new}' where stu_id='{$_SESSION['fsid']}'");
        if($u)
        {
		...
		<div class="card-body">
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Forget Password</div>
			  ...
			  <label for="exampleInputUsername" class="sr-only" >Enter New Password</label>
			   <div class="position-relative has-icon-right">
                               <input type="text" id="exampleInputUsername" class="form-control input-shadow" placeholder="Enter new password" name="new1">
			  ...
			  <label for="exampleInputUsername" class="sr-only" >Confirm Password</label>
			   <div class="position-relative has-icon-right">
                               <input type="text" id="exampleInputUsername" class="form-control input-shadow" placeholder="confirm password" name="new2">
				  <div class="form-control-position">
					  <i class="icon-user"></i>
				  </div>
			   </div>
