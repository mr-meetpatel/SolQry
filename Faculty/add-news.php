...
if(isset($_POST['btn']))
{
     ...
     $q= mysqli_query($con, "INSERT INTO `news_master` (`from_u_id`,`from_id`,`u_id`, `b_id`, `news`, `news_expire_date`) VALUES ('2',{$_SESSION['fid']},{$user}, '{$_SESSION['fb_id']}', '{$new_details}',  '{$enddate}');") or die(mysqli_error($con));
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="input-6" name="user" required>
                        ...
                        {
                            if($userdata['u_id']!=1 && $userdata['u_id']!=2)
                            {
