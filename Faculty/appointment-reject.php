...
$time= date('H:i:sa');
$date=date("Y-m-d");
     $q= mysqli_query($con, "update appointment_master set app_status='0',app_date='{$date}',app_time='{$time}',msg='{$_POST['app']}' where app_id='{$_GET['raid']}'");
     $notificationq=mysqli_query($con,"INSERT INTO `notification_master` ( `n_from`, `n_to`,`b_id`,`id`,`notification`, `status`) VALUES ( '3', 'Student','{$_SESSION['fb_id']}','{$facultydata['stu_id']}','Appointment Rejected', '1');");
     if($q)
     {
