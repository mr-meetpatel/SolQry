...
if(!isset($_SESSION['fid']))
{
    ...
    $updatenotification=mysqli_query($con,"update notification_master set status=0 where n_to='Faculty' and b_id='{$_SESSION['fb_id']}' and id='{$_SESSION['fid']}' and notification='New Appointment Added'");
        ?>
<script>
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Appointments Details</div>
            <div class="card-body">
