...
$date=date("Y-m-d");
$select= mysqli_query($con, "select * from events where f_id='{$_SESSION['fid']}' and u_id=2");
...
$update=mysqli_query($con, "update events set start_event='{$date}',start_event_time='{$start_time}',end_event_time='{$end_time}' where id={$id}") or die(mysqli_error($con));
if($update)
{
    echo "<script>alert('Updated..');</script>";
}
}else{
  echo "<script>alert('Time Invalid');</script>";
}
}
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            <h4 class="page-title">Update Event Form</h4>
          ...
          <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <select name="title" class="form-control" onchange="loadTime(this.value)">
